...
<!--             Hier wordt de container geopend waarin tekst, foto's, enzo in geplaatst kunnen worden. -->
            ...
            <br>
            <div class="grid_16"><h1>Algemene resultaten</h1></div>
			
			<div id="freeow" class="freeow freeow-top-right"></div>
            
			<div class="grid_9 minimum-except">
				<p>Klik op de knop hieronder om het overzicht met de algemene resultaten van alle bieren te downloaden, samen met de uitslag van de Biercompetitie.</p>
				<br>
				<div id="rd-button-orange">
					<label>
						<button type="submit" class="bo-btn-download" onclick="location.href='./BO-KeurdersToevoegen.php'">
							<span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>   &nbsp; Download algemeen overzicht
						</button>
					</label>
				</div>
            </div>
