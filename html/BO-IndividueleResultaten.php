...
<!--             Hier wordt de container geopend waarin tekst, foto's, enzo in geplaatst kunnen worden. -->
            ...
            <br>
            <div class="grid_16"><h1>Individuele resultaten</h1></div>
			
			<div id="freeow" class="freeow freeow-top-right"></div>
            
			<div class="grid_9 minimum-except">
				<p>Vul de flesnummer in van het bier waarvan u de resultaten wilt weergeven. <br>
				De resultaten zullen hieronder vervolgens onmiddelijk verschijnen.</p>
				<br>
				<select class="inputveld">
					<option>Flesnummers</option>
				</select>
				<br><br><br><br><br><br><br><br>
				<div class="clear"></div>
				<div id="rd-button-green">
					<label>
						<button type="submit" class="bo-btn-download" onclick="location.href='./#'">
							<span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>   &nbsp; Download individuele overzicht
						</button>
					</label>
				</div>
            </div>
