...
<!--             Hier wordt de container geopend waarin tekst, foto's, enzo in geplaatst kunnen worden. -->
            ...
            <br>
            <div class="grid_16"><h1>Resultaten weergeven</h1></div>
			
			<div id="freeow" class="freeow freeow-top-right"></div>
            
			<div class="grid_9 minimum-except">
				<p>Maak een keuze voor welke resultaten u wil weergeven.</p>
				<br>
				<div id="rd-button-orange">
					<label>
						<button type="submit" class="bo-btn" onclick="location.href='./BO-AlgemeneResultaten.php'">
							Algemene resultaten weergeven
						</button>
					</label>
				</div>
				...
				<div id="rd-button-orange">
					<label>
						<button type="submit" class="bo-btn" onclick="location.href='./BO-IndividueleResultaten.php'">
							Individuele resultaten weergeven
						</button>
					</label>
				</div>			
			</div>
