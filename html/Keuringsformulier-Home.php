...
<head>
	...
	<script type="text/javascript"> 
		...
		<!-- zorgt ervoor dat de functionaliteit van de back pijltjes van de browser  niet meer werkt. -->
	...
	<?php
		...
		/* Functie dat ervoor zorgt dat je deze pagina niet kunt accessen zonder dat er een keurderID session is aangemaakt. 
			Dit gebeurt bij de login. */
		session_start();
    ...
    <div id="wrap">
        <div id="main">
					...
					<div id="navigatie">
						<nav>
							...
							<ul id="main-menu" class="sm sm-clean collapsed">
								...
								<li>
									<a href="./AccountKeurder.php" class="">Account</a>
								</li>
								<li>
            ...
            <div class="container_16">
				<BR>
				<div class="grid_16">
					<h1>Keuringsformulier BBC 2015</h1>
				</div>
				<BR>
				<div class="clear"></div>
				...
				<div class="grid_9 minimum-except">
					<h2>Welkom bij het keuringsformulier van de Brouwland Biercompetitie, editie 2015.</h2>
					<BR>
					<p>U zal nu geleid worden door een geautomatiseerd keuringsverslag. Om u te kunnen navigeren tussen de verschillende keuringsonderdelen kan u gebruik maken van de knoppen 'Vorige' en 'Volgende' of door te klikken op het gewenste onderdeel in het menu bovenaan, onder 'Keuring'.</p>
					<BR>
					<h2>Klik op 'Start' om aan de keuring te beginnen.</h2>
					<BR><BR><BR><BR><BR><BR>
				</div>
				<!-- einde body -->
				
				<div class="grid_24 minimum-except">
					<button type="button" class="next-btn" name="b1" onclick="location.href='./Keuringsformulier-Flesnummer.php'">
						Start<span class="glyphicon glyphicon-chevron-right"></span>
					</button>
				</div>
				<div class="clear"></div>
				<br><br>
