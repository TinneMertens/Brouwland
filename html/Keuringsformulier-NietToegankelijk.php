...
<head>
	...
	<?php
		...
		//Hier wordt de MySQL-connectie geopend
        ...
        <div id="main">
            ...
            <div class="container_16">
				...
				<div class="grid_9 minimum-except">
					...
					<BR>
					<p>De keuring is toegankelijk van <?php echo $startDate; ?>, <?php echo $startHour; ?>u tot <?php echo $endDate; ?>, <?php echo $endHour; ?>u.</p> 
					<BR>
					<h2>Gelieve later terug te komen.</h2>
					<BR><BR><BR><BR><BR><BR>
				</div>
				<!-- einde body -->
