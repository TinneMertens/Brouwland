...
<head>
		...
		$(document).ready(function () {
			var checkInput = decodeURIComponent(document.location.href.substring(document.location.href.indexOf("check=") + 6)); //Foutief wachtwoord en/of login.
			var checkInput2 = decodeURIComponent(document.location.href.substring(document.location.href.indexOf("session=") + 8)); //Fout als men probeert toegang te krijgen tot een pagina waarvoor men aangemeld moet zijn.
			var checkInput3 = decodeURIComponent(document.location.href.substring(document.location.href.indexOf("cp=") + 3)); //Melding als wachtwoord succesvol gewijzigd is.
			
			if (checkInput === "false" ) {
				$("#freeow").freeow("Fout bij inloggen", "De gebruikersnaam en/of wachtwoord dat u invulde zijn niet correct. <br><br> Gelieve uw login-gegevens opnieuw in te vullen.", {
					classes: ["osx", "notice"],
					autoHide: false
				});
			}
			...
			if (checkInput2 === "false" ) {
				$("#freeow").freeow("Opgepast", "Gelieve eerst aan te melden alvorens u toegang krijgt tot de pagina.", {
					classes: ["osx", "notice"],
					autoHide: false
				});
			}
			...
			if (checkInput3 === "true" ) {
				$("#freeow").freeow("Wachtwoord", "Uw wachtwoord is succesvol gewijzigd.", {
					classes: ["osx", "notice"],
					autoHide: false
				});
			}
...
<form action="LoginCode.php" method="post">
  ...
  <li><a href="./Registratie.php" class="" >Deelnemen</a></li>
...
<!--             Hier wordt de container geopend waarin tekst, foto's, enzo in geplaatst kunnen worden. -->
             ...
             <div class="container_16">
              ...
              <div class="grid_16"><h1>Login</h1></div>
              <div class="clear"></div>
<!--              Donker bruine kleinere titel en gewone tekst worden in een grid geplaatst. -->
             ...
             <div class="grid_9 minimum-except">
              <h2>Gebruikersnaam</h2>
				...
				<div class="form-item2">
				 <input name="Teamnaam" type="text" class="required inputveld" maxlength="100" aria-required="true">
				</div>
              ...
              <h2>Wachtwoord</h2>
				...
				Wachtwoord</div>
				<div class="form-item2">
				 <input name="Wachtwoord" type="password" class="required inputveld" maxlength="100" aria-required="true">
				</div>
			   
			  
				<div class="clear"></div>
				 <a href="ChangePassword.php">Wachtwoord veranderen</a> 
              <div class="clear"></div><br>
              
              <div class="form-item7">
               <input type="checkbox" class="check" id="switch" name="check_one" checked />
				...
				<div class="form-item2">
				 <p><i>Gegevens onthouden?</i></p>
				</div>
				<div class="clear"></div>
				
				<br>
			
              <input type="submit" name="Submit1" value="Login" border="0" class="form-btn">
	      </form>
              <div class="clear"></div><br><br>
              <h3>Heb je nog geen account?</h3>
              <br>
	      <form action="./Registratie.php" method="get">
              <input type="submit" value="Registreren" border="0" class="form-btn">
	      </form>
              <br>
              <br>
              <br>
              ...
              <div class="grid_6 minimum-except">
            	<p></p><figure><img src="Image/pic-biercompetitie2.jpg" alt="Brouwland Biercompetitie" class="img-default"></figure><p></p>
              </div>
              <div class="clear"></div>
