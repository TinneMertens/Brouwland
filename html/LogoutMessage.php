            ...
            <div class="grid_16">
				...
				<nav>
					...
					<ul id="main-menu" class="sm sm-clean collapsed">
					  ...
					  <li><a href="#" class="has-submenu" aria-haspopup="true">Hulp nodig?<span class="sub-arrow"></i></span></a>
...
<!--             Hier wordt de container geopend waarin tekst, foto's, enzo in geplaatst kunnen worden. -->
            ...
            <div class="container_16">
            <br>
            <div class="grid_16"><h1>Logout</h1></div>
            
			<div class="grid_9 minimum-except">
			<br>
	 	<h2>U werd succesvol uitgelogd.</h2>
    <!--     	<h5>U werd succesvol uitgelogt.</h5> -->
				<h5>Graag tot de volgende keer.</h5>
		
			<br>
			<div>
			<div style="position: absolute;">
			<form action="./Login.php">
              <input type="Submit" value="Home " border="0" class="form-btn">
             </form>
             </div>
              <br>
              </div>
              ...
              <div class="grid_6 minimum-except">
            	<p></p><figure><img src="Image/keurdersTafel.jpg" alt="Brouwland Biercompetitie" class="img-default" width="400" height="260"></figure><p></p>
              </div>
              <div class="clear"></div>
	 		</div>
