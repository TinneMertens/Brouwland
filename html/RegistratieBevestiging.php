					...
					<div id="navigatie">
						<nav>
							...
							<ul id="main-menu" class="sm sm-clean collapsed">
								...
								<li>
									<a href="http://localhost:8080/Brouwland-Web-Application/Registratie.php" class="" >Deelnemen</a>
								</li>
								<li>
									<a href="http://localhost:8080/Brouwland-Web-Application/Login.php" class="current">Login</a>
								</li>
								<li>
...
<!--             Hier wordt de container geopend waarin tekst, foto's, enzo in geplaatst kunnen worden. -->
            ...
            <div class="container_16"> 
				<BR>
				<div class="grid_16">
					<h1>Bevestiging van registratie</h1>
				</div>
				<div class="clear"></div>
				<div class="grid_9 minimum-except">
					<h5>U registratie werd succesvol verwerkt.</h5>
					<h5>In enkele ogenblikken ontvangt u een mail met de nodig login gegevens voor uw account.</h5>
				</div>
